...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'jonathan83715.aternos.me', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 19886,                // Puerto predeterminado de Minecraft
        username: 'bot de jonathan',    // Nombre genérico del bot/NPC dentro del juego
